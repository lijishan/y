...
<div class="grid_12">
      <div class='weather_box' style='height:36px'>
        <div class="grid_4 alpha" style='padding:8px'>
          <iframe name="weather_inc" src="http://cache.xixik.com.cn/11/guangxiyulin/" width="460" height="15" frameborder="0" marginwidth="0" marginheight="0" scrolling="no" ></iframe>
        </div>
            ...
            <div id="tabs1" class="news-widget1">
                ...
                <div id="tabs-1">
                    ...
                    if (ubound(array_news) > 0) then
                        ...
                        %>
                            <li class="news-item"><!--[<%=class_id%>]-->
                              <a target=_blank href="view.asp?what=article&id=<%=id%>"><%=title%></a>&nbsp;&nbsp;<span>[<%=pub_time%>]</span></li>
                    <%
                        next
                    %>
...
<div id="tabs-2">
        ...
        <div class="grid_3 omega" id="info">
            <div class=" news-widget1 info-widget">
              ...
              <h4 align="left" class="section-header header">近期招聘会 <span><a href="list.asp?class=<%=class_id%>">更多&gt;&gt;</a></span></h4>
                <div align="left">
                  <ul>
                    <!--#include file="index_info.asp"-->
                    <%
                    ...
                    <li class="news-item">
                      <!--[<%=class_id%>]-->
                      <a target=_blank href="view.asp?what=article&id=<%=id%>"><%=title%></a></li>
                    <%
                        next
                    else
                    %>
...
<div id="followDiv2" style="z-index: 10; position: absolute; width: 80px; height: 60px; right: 2px; top: 389px; "><a href="javascript:popMe()" rel="noreferrer"><img src="ad/db.gif" border="0" alt=""></a><br></div>
