...
<% if Request.Cookies("sjob")<>"ok" then %>
 <font color=#FF0000> 重要提示：请您先把个人信息填写完成后【免费的】，再来搜索职位信息！！</font>
  <%else%> 
 <input border="0" src="images/s2.gif" name="I1" width="53" height="20" type="image">&nbsp;&nbsp;&nbsp;&nbsp;	
<%end if %>	
<%end if %>										
...
&nbsp;&nbsp;&nbsp;&nbsp;3、本功能为会员专有功能，功能强于前台的普通搜索。 </span></p>
									<span class="STYLE6">更 多 相 关 搜 索 ↓<br></span><iframe id="baiduframe" marginwidth="0" marginheight="0" scrolling="no"
