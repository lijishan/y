...
<form method="POST" name="form1" action="updata_service.asp">
						<p>　</p>
						<p><a href="admin_up_service.asp?id=1&what=法律申明">法律申明</a>&nbsp;
						...
						<a href="admin_up_service.asp?id=5&what=什么是委托招聘">什么是委托招聘</a>&nbsp;
						<a href="admin_up_service.asp?id=6&what=怎么申请委托招聘">怎么申请委托招聘</a>&nbsp;
						<a href="admin_up_service.asp?id=7&what=委托招聘的收费标准">委托招聘的收费标准</a></p>
  ...
  <option style="background-color:#9ACD32;color: #9ACD32" value="#9ACD32">
	#9ACD32</option>
          ...
          <tr bgcolor="#F7F7F7">
			...
			<textarea name="service" cols="75" rows="25" id="content"><%=rs("service")%></textarea></td>
          </tr>
          <tr bgcolor="#F7F7F7">
