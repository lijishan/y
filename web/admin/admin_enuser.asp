...
<table border="0" width="100%" cellspacing="0" cellpadding="4" bgcolor="#FFFFFF" style="border:1px solid #000000; " height="229">
	...
	<tr>
		...
		<td bgcolor="#F1F3F5" height="26" align="center" width="60" valign="top">
					<a href="admin_enuser.asp">全部显示</a></td>
	</tr>
	<tr>
...
%>	
    	 ...
    	 <%if rs("vip")=false then response.write"否"%></td>
			  ...
			  <p align="center"><%=rs("rdate")%></td>
				...
				查看</a></td>
				<td style="border-bottom: 1px dotted #000000; padding-left: 4px; padding-right: 4px; padding-top: 1px; padding-bottom: 1px" width="78" align="center" bgcolor="#E5E5E5"><a href="../en_control1a.asp?id=<%=rs("id")%>&ac=<%=rs("ac")%>&ttype=2">图片设置</a></td>
