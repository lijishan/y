...
<OPTION VALUE="30">一个月内</OPTION> <OPTION VALUE="183">六个月内</OPTION>
				...
				<%else
response.write "<font color=#FF0000>登录后搜索,仅供企业用户(已发招聘者)使用</font>"
end if %></td>
</form>
										</tr>
...
'sql="select id,name,job1,hkb,edu,sex,rdate,zhuanyen1 from in_user where name<>''and job<>'' and lock=false" 职位不能为空
...
%>
								<tr>
										<td style="border-left-width: 1px; border-right-width: 1px; border-top-width: 1px; " width="734" height="42" align="center" colspan="7"><table width="650" border="0" cellspacing="0">
                                          ...
                                          <tr>
                                            <td><span class="STYLE13">更多人才搜索-&gt;请输入你想人才类型（如：数学教育、销售助理、平面设计等）：</span></td>
                                          </tr>
                                          <tr>
                                            <td><div align="center">
