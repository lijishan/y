...
<title><%=webname%> - 会员中心 - 人才超级搜索</title>
<style type="text/css">
<!--
						...
						<div align="center">
							<table border="0" width="100%" cellspacing="0" cellpadding="0" id="table3" height="272">
								...
								<tr>
									...
									<p>&nbsp;</p>
									<p ><font color =#ff0000 size=4><strong>企 业 人 才 超 级 搜 索</strong></font></p>
...
应聘者希望的职位关键字，如：会计，管理，设计...不输为不限</td>
									</tr>
									<tr>
									  <td height="30"><input name="zy" type="text" style="padding-left: 4px; padding-right: 4px; padding-top: 1px; padding-bottom: 1px" onFocus="this.value=''" value="应聘者专业关键字" size="20" maxlength="20">
								      应聘者所学专业，如计算机，财会电算化...，不输为不限</td>
							  </tr>
									<tr>
...
<font color=#FF0000>抱歉，普通会员超级搜索功能免费体验时间为3天，你的体验时间已到期<br>此超级搜索功能为本站 <strong>VIP用户</strong> 无限期专有<br>请升级成本站VIP用户后使用，联系QQ：451079368，电话：13981528686</font><br>普通会员体验到期后，请直接使用本站提供的前台【普通搜索】功能。
<%else%>
 <% if Request.Cookies("newjob")<>"ok" then %>
 <font color=#FF0000> 重要提示：请您先发布招聘职位后【免费的】，再来搜索人才信息！！</font>
  <%else%> 
 <input border="0" src="images/s2.gif" name="I1" width="53" height="20" type="image">&nbsp;&nbsp;&nbsp;&nbsp;	
<%end if %>	
<%end if %>										
<%end if %>
									...
									<p align="left" class="STYLE4">搜索方法说明：<br><br>&nbsp;&nbsp;&nbsp;&nbsp;1、所有搜索项目均为可选项目。<br>
									  &nbsp;&nbsp;&nbsp;&nbsp;2、本搜索使用了模糊查找技术，【具体城市】、【职位关键字】和【专业关键字】均是支持模糊查找。如：在【具体城市】中输入“京”，可找到类似“京”、“北京”、“南京”，“东京”等包含有“京”字的所有信息；在【职位关键字】中，输入：“会计”，类似“会计”、“注册会计”、“应用会计”等包含有“会计”内容均能查找到。<font color=#ff0000>建议关键字从大范围开始查找然后再逐步缩小，即输入关键字的字数由少到多来确定搜索范围。</font><br>
									  &nbsp;&nbsp;&nbsp;&nbsp;3、本功能为会员专有功能，功能强于前台的普通搜索。<br>
 									  </p> 
									<span class="STYLE6">更 多 相 关 搜 索 ↓</span> <br> 
  ...
  src="http://unstat.baidu.com/bdun.bsc?tn=ggang6_pg&cv=1&cid=1009000&csid=243&bgcr=ffffff&ftcr=000000&urlcr=0000ff&tbsz=335&sropls=1,2,3,4,5,6&kwgp=0">
</iframe>
</p>
									<p align="left"> &nbsp;&nbsp;&nbsp;&nbsp;<span class="STYLE3">提示：搜索到你理想的人才，你可加入你的人才库并给求职者发站内短信或按其提供的联系方式联系，以确定进一步的联系！</span></p>
									<p>&nbsp;</p></td>
								</tr>
							</table>
						</div>
