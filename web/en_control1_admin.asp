				...
				<table border="0" width="705" cellspacing="0" cellpadding="0" id="table2" height="379">
					...
					<tr>
					  <td width="705" colspan="4" valign="top">
						<%
sql="select email,name,trade,cxz,fund,yuangong,area,faren,fdate,jianj,address,zip,pname,pnames,phone,fax,renshi,sex,rstel,web from en_user where id="&clng(Request.Cookies("id"))
							...
							<table border="0" width="100%" cellspacing="0" cellpadding="0" id="table3" height="272">
								...
								<tr>
								  ...
								  <td width="75%" valign="top" align="center" style="border: 1px solid #000000">
									<form method="POST" action="upinfo_en_admin.asp">
										<table border="0" width="93%" cellspacing="0" cellpadding="0" id="table5">
											...
											<tr>
											  ...
											  <td height="40"><INPUT TYPE="text" NAME="name" SIZE="40"  MAXLENGTH=40 VALUE="<%=rs("name")%>" STYLE="border: 1px solid #000000; padding-left: 4; padding-right: 4; padding-top: 1; padding-bottom: 1; background-color: #FFfFFF"></td>
											  <td height="40"><span class="STYLE2">*</span></td>
											</tr>
											<tr>
...
<INPUT TYPE="text" NAME="phone" SIZE="20"  MAXLENGTH=40 VALUE="<%=rs("phone")%>" STYLE="border: 1px solid #000000; padding-left: 4; padding-right: 4; padding-top: 1; padding-bottom: 1; background-color: #FFfFFF">
<font color="#FF0000">*</font></td>
											</tr>
											<tr>
...
<INPUT TYPE="text" NAME="rstel" SIZE="20" MAXLENGTH=40 VALUE="<%=rs("rstel")%>" STYLE="border: 1px solid #000000; padding-left: 4; padding-right: 4; padding-top: 1; padding-bottom: 1; background-color: #FFfFFF"></td>
											...
											<tr>
												...
												<td height="40" width="58%"> 
<INPUT TYPE="text" NAME="web" SIZE="20" MAXLENGTH=40 VALUE="<%=rs("web")%>" STYLE="border: 1px solid #000000; padding-left: 4; padding-right: 4; padding-top: 1; padding-bottom: 1; background-color: #FFfFFF"></td>
												<td height="40" width="17%">　											    </td>
											</tr>
											<tr>
												<td height="40" colspan="3">
