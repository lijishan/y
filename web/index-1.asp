  ...
  <div class="grid_12">
      <div class='weather_box' style='height:36px'>
        <div class="grid_4 alpha" style='padding:8px'>
          <iframe name="weather_inc" src="http://cache.xixik.com.cn/11/guangxiyulin/" width="360" height="15" frameborder="0" marginwidth="0" marginheight="0" scrolling="no" ></iframe>
        </div>
